...
import EditQuestionHeader from "../../components/admin/question/EditQuestionHeader";
import FlagInfoBanner from "../../components/admin/question/FlagInfoBanner";
import RejectFlagModal from "../../components/admin/question/RejectFlagModal";
      ...
      <div className="min-h-full bg-[#F5F7FB] px-4 py-6 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-[1200px]">
          ...
          <EditQuestionHeader
            ...
            updateKey="gatherer.addNewQuestion.update"
            isFlagged={isFlagged}
            onRejectFlag={() => setShowRejectFlagModal(true)}
            rejectFlagKey="gatherer.addNewQuestion.rejectFlag.button"
          />

          {/* Flag Info Banner */}
          <FlagInfoBanner flagReason={flagReason} t={t} />
