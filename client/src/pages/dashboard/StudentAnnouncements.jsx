                      ...
                      <td className="px-6 py-4">
                        {!announcement.isRead && (
                          <span className="inline-flex items-center gap-1">
                            ...
                            <span className="text-[12px] font-roboto text-[#ED4122]">
                              {t('dashboard.announcements.unread') || 'Unread'}
                            </span>
                          </span>
                        )}
                        {announcement.isRead && (
                          <span className="text-[12px] font-roboto text-dark-gray">
                            {t('dashboard.announcements.read') || 'Read'}
                          </span>
                        )}
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="px-3 py-1.5 text-[12px] font-roboto font-medium text-oxford-blue bg-blue-50 hover:bg-blue-100 rounded-md transition-colors"
                          >
                            {t('dashboard.announcements.view') || 'View'}
                          </button>
                          <button
                            onClick={() => handleDelete(announcement)}
                            className="px-3 py-1.5 text-[12px] font-roboto font-medium text-[#EF4444] bg-red-50 hover:bg-red-100 rounded-md transition-colors"
                          >
                            {t('dashboard.announcements.delete') || 'Delete'}
                          </button>
                        </div>
                      </td>
                    </tr>
