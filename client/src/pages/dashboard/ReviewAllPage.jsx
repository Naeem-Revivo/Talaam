      ...
      <div className="flex h-[calc(100vh-120px)] md:h-[calc(100vh-120px)] pb-[180px] md:pb-0">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
          <div className="max-w-4xl mx-auto lg:ml-5">
            {/* Question Id - Mobile */}
            <div className="lg:hidden text-[14px] font-normal text-[#6B7280] font-roboto mb-2">
              Question Id: {currentQuestion.id}
            </div>

            {/* Title */}
            <h2 className="text-[24px] md:text-[32px] lg:text-[36px] font-bold text-[#032746] mb-2 md:mb-4 font-archivo leading-tight tracking-[0%]">
              Review Full Session
            </h2>

            {/* Subtitle */}
            <p className="text-[14px] md:text-[16px] font-normal text-[#6B7280] font-roboto mb-6 md:mb-10 leading-[24px] tracking-[0%]">
            ...
            <div className="mb-4 md:mb-6">
              ...
              >
                ...
                <span className="md:hidden">New Question</span>
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="fixed md:relative bottom-0 left-0 right-0 bg-white border-t border-[#E5E7EB] px-4 md:px-6 py-3 md:py-4 z-30 shadow-[0_-2px_10px_0px_rgba(0,0,0,0.05)] md:shadow-none">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-3 sm:gap-4 md:gap-10">
          ...
          <button 
            ...
            className="w-full sm:w-auto px-4 py-2 bg-[#C6D8D3] text-[#032746] rounded-lg text-[14px] md:text-[16px] font-normal font-roboto hover:opacity-90 transition-opacity"
          >
            Review Incorrect
          </button>
          <button
