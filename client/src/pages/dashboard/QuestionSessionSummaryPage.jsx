      ...
      <header className="bg-white border-b border-[#E5E7EB] px-4 md:px-6 py-3 md:py-4 sticky top-0 z-20">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div className="flex items-center justify-between gap-4 w-full lg:w-auto">
            ...
            <button className="lg:hidden text-[#032746] hover:opacity-70">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
          <div className="max-w-6xl mx-auto">
            <h1 className="font-archivo text-[36px] leading-[40px] font-bold text-[#032746] mb-1">
              Session Complete
            </h1>
            <p className="font-roboto text-[18px] leading-[28px] text-[#6B7280] mb-8">
              Here’s how you performed in this session.
            </p>

            <div className="grid gap-6 lg:grid-cols-2">
              <div className="bg-white rounded-2xl shadow-[0px_6px_40px_rgba(3,39,70,0.08)] border border-[#E5E7EB] w-full md:w-[548px] md:h-[251px] p-6 flex flex-col">
                <h2 className="font-archivo text-[18px] font-semibold leading-[28px] text-[#032746] mb-4">Accuracy snapshot</h2>
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 flex-1">
                  <div className="flex flex-col gap-1 md:max-w-[160px]">
                    <div className="font-roboto text-[16px] leading-[25px] text-[#6B7280]">
                      Keep the momentum going—your accuracy curve stayed strong across this session.
                    </div>
                  </div>
                  <div className="relative flex items-center justify-center w-[120px] h-[120px] mx-auto md:mx-0">
                    ...
                    <div className="absolute text-[24px] font-bold text-[#032746] font-archivo">
                  ...
                  <div className="flex flex-col gap-3 min-w-[150px] md:items-start">
                    <div className="flex flex-col">
                      ...
                      <span className="font-roboto text-[16px] leading-[24px] font-normal text-[#032746]">
                        {summary.correctCount} questions
                      </span>
                    </div>
                    <div className="flex flex-col">
                      <span className="font-roboto text-[16px] leading-[24px] font-normal text-[#6B7280]">
                        Incorrect
                      </span>
                      <span className="font-roboto text-[16px] leading-[24px] font-normal text-[#032746]">
                        {summary.incorrectCount} questions
                      </span>
                    </div>
                  </div>
                </div>
                 <div className="grid grid-cols-1 sm:grid-cols-2 pt-1 gap-3 text-[16px] leading-[24px] font-roboto text-[#032746]">
                  <span>Questions answered {summary.questionsAnswered}</span>
                  <span className="sm:text-right">Average pace {summary.averagePace}</span>
                </div>
              </div>

              <div className="bg-white rounded-2xl shadow-[0px_6px_40px_rgba(3,39,70,0.08)] border border-[#E5E7EB] w-full md:w-[548px] md:h-[251px] p-6 flex flex-col">
                <span className="font-roboto text-[16px] leading-[24px] text-[#6B7280] mb-1">
                  {summary.testMode ? 'Test mode' : 'Study mode'}
                </span>
                <h3 className="font-archivo text-[18px] leading-[28px] font-semibold text-[#032746] mb-1">
                  Get to know your session at a glace
                </h3>
                <p className="font-roboto text-[16px] leading-[25px] text-[#6B7280] mb-2">
                  Feedback unlocks now that the timer has ended. Dive into every explanation or focus on the questions you missed.
                </p>
                <div className="bg-[#EF4444] rounded-2xl w-full md:w-[499px] h-[90px] py-4 flex items-center gap-4 justify-center text-white">
                  ...
                  <div>
                    ...
                    <div className="text-[13px] font-roboto text-white/80">
                      {summary.questionsAnswered} total, {summary.timeTaken} overall, {summary.averagePace} average
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid gap-6 mt-6 md:grid-cols-3">
              <div className="bg-white rounded-2xl shadow-[0px_6px_40px_rgba(3,39,70,0.08)] border border-[#E5E7EB] p-6">
                <h4 className="font-archivo text-[18px] leading-[28px] font-semibold text-[#032746] mb-2">Accuracy</h4>
                <div className="font-archivo text-[24px] leading-[32px] font-bold text-[#032746] mb-2">
                  {summary.accuracyPercent}%
                </div>
                <div className="font-roboto text-[16px] leading-[25px] text-[#6B7280]">
                  Percentage of correct answer in this session.
                </div>
              </div>
              <div className="bg-white rounded-2xl shadow-[0px_6px_40px_rgba(3,39,70,0.08)] border border-[#E5E7EB] p-6">
                <h4 className="font-archivo text-[18px] leading-[28px] font-semibold text-[#032746] mb-2">Question outcome</h4>
                <div className="font-archivo text-[24px] leading-[32px] font-bold text-[#032746] mb-2">
                  {summary.correctCount} Correct / {summary.incorrectCount} Incorrect
                </div>
                <div className="font-roboto text-[16px] leading-[25px] text-[#6B7280]">
                  {summary.questionsAnswered} Questions completed
                </div>
              </div>
              <div className="bg-white rounded-2xl shadow-[0px_6px_40px_rgba(3,39,70,0.08)] border border-[#E5E7EB] p-6">
                <h4 className="font-archivo text-[18px] leading-[28px] font-semibold text-[#032746] mb-2">Time taken</h4>
                <div className="font-archivo text-[24px] leading-[32px] font-bold text-[#032746] mb-2">
                  {summary.timeTaken}
                </div>
                <div className="font-roboto text-[16px] leading-[25px] text-[#6B7280]">
                  Average {summary.averagePace} question
                </div>
              </div>
            </div>
      ...
      <footer className="bg-white border-t border-[#E5E7EB] px-4 md:px-6 py-3 md:py-4 sticky bottom-0 z-20">
        <div className="mx-auto flex max-w-5xl justify-end">
          <button
            ...
            className="px-5 py-2.5 bg-white border border-[#E5E7EB] text-[#032746] rounded-lg text-[14px] md:text-[16px] font-roboto hover:opacity-90 transition"
          >
            Go to Dashboard
          </button>
        </div>
