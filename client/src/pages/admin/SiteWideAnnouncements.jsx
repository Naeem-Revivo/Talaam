                ...
                <header className="flex flex-col justify-between gap-4 lg:flex-row lg:items-center w-full">
                    ...
                    <div className="flex flex-wrap lg:justify-end gap-3">
                        <button
                            ...
                            className="h-[36px] px-5 rounded-[10px] border border-[#E5E7EB] bg-white text-[16px] font-roboto font-medium leading-[16px] text-oxford-blue transition hover:bg-[#F3F4F6] flex items-center justify-center gap-2"
                        >
                            ...
                            {t('admin.siteWideAnnouncements.buttons.previewAnnouncements')}
                        </button>
                        <button
                            type="button"
