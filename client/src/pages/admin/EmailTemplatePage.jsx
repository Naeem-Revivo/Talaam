...
const EmailTemplateForm = ({ title, subjectPlaceholder, bodyPlaceholder, onSave, onPreview }) => {
            ...
            <div className="space-y-6 px-5 pt-5 pb-12">
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3 bg-[#E5E7EB] border border-[#03274633] rounded-lg font-roboto text-[14px] leading-[20px] text-[#6B7280] placeholder:text-[#6B7280] focus:outline-none focus:ring-[1px] focus:ring-[#032746] focus:border-transparent"
                    />
                </div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows={6}
                        className="w-full px-4 py-3 bg-[#E5E7EB] border border-[#03274633] rounded-lg font-roboto text-[14px] leading-[20px] text-[#6B7280] placeholder:text-[#6B7280] focus:outline-none focus:ring-[1px] focus:ring-[#032746] focus:border-transparent resize-none"
                    />
                </div>
            </div>
        </div>
        ...
        <div className="min-h-screen bg-[#F5F7FB] px-4 xl:px-6 py-6 sm:px-6 2xl:px-[66px]">
            <div className="mx-auto flex max-w-[1200px] flex-col gap-8">
                <header className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
                    <div>
                        ...
                        <p className="font-roboto text-[18px] leading-[28px] text-[#6B7280]">
                            Manage and customize the email template used by the system
                        </p>
                    </div>
                </header>
                ...
                <div className="space-y-6 sm:space-y-[73px]">
                    <EmailTemplateForm
                        title="Welcome Email"
                        subjectPlaceholder="Welcome to Acme Co!"
                        bodyPlaceholder="Hi {Name} Thanks for joining us..."
                    ...
                    <EmailTemplateForm
                        ...
                        bodyPlaceholder="Click the link below to reset your password..."
                    ...
                    <EmailTemplateForm
                        ...
                        subjectPlaceholder="Your subscription is ending soon"
                        bodyPlaceholder="Dear {Name} of {Company} your subscription..."
