...
const getTabConfig = (subjects, topics, subtopics, concepts, t) => ({
    ...
    Subtopics: {
        ...
        emptyMessage: t('admin.classificationManagement.table.emptyState.subtopics'),
...
const ClassificationManagement = () => {
    ...
    const statsData = [
        { label: t('admin.classificationManagement.stats.subjects'), value: subjects.length },
        { label: t('admin.classificationManagement.stats.topics'), value: topics.length },
        { label: t('admin.classificationManagement.stats.subtopics'), value: subtopics.length },
        { label: t('admin.classificationManagement.stats.concepts'), value: concepts.length },
    ];
