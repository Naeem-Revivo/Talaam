    ...
    <div className="min-h-full bg-[#F5F7FB] px-4 py-6 sm:px-6 xl:px-6 2xl:px-[66px]">
      <div className="mx-auto flex max-w-[1400px] flex-col gap-6">
        <div className="flex flex-col gap-6 md:flex-row lg:flex-row">
          ...
          >
            <h2 className="mb-4 md:mb-6 font-archivo text-[20px] md:text-[24px] font-bold leading-[28px] text-[#032746]">
              My Tasks
            </h2>
              ...
              {draftVariants.map((variant) => (
                ...
                >
                  <div className="flex flex-col gap-1">
                    <span className="font-roboto text-[16px] font-semibold leading-[20px] text-[#032746]">
                      {variant.name}
                    </span>
                    <span className="font-roboto text-[14px] leading-[20px] text-[#6B7280]">
                      Variant of: {variant.sourceQuestion}
                    </span>
                  </div>
                  <svg
                    width="20"
            ...
            <div className="mb-4 md:mb-6">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-[8px] border border-[#E5E7EB] bg-white py-3 pl-12 pr-4 font-roboto text-[16px] leading-[20px] text-[#032746] placeholder:text-[#9CA3AF] focus:border-[#ED4122] focus:outline-none focus:ring-2 focus:ring-[#ED4122] focus:ring-opacity-20"
                />
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full appearance-none rounded-[8px] border border-[#E5E7EB] bg-white py-3 pl-4 pr-10 font-roboto text-[16px] leading-[20px] text-[#032746] focus:border-[#ED4122] focus:outline-none focus:ring-2 focus:ring-[#ED4122] focus:ring-opacity-20"
                    >
                      <option value="">Select a claimed question</option>
