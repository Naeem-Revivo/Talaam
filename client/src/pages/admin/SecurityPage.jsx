        ...
        <div className="max-w-[1200px] mx-auto py-10 px-6">
            <header className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center mb-[30px]">
                    ...
                    <div className="flex flex-wrap gap-3">
                        <button
                            type="button"
                            onClick={handleRoles}
                            className="h-[36px] px-5 rounded-md border border-[#E5E7EB] bg-white text-[16px] font-roboto font-medium leading-[16px] text-[#032746] transition hover:bg-[#F3F4F6] flex items-center justify-center gap-2"
                        >
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-xl pt-8 pb-10 space-y-10">
                ...
                <section className="px-8 ">
                    <h2 className="text-[20px] leading-[100%] font-semibold text-[#032746] mb-3">Security & Authentication</h2>
                    <p className="text-[14px] leading-[100%] text-[#032746]">Manage password rules, two-factor authentication, and sensitive action controls.</p>
                </section>

                {/* Password Policy */}
                <section className="border-t pt-6 px-8">
                    <h3 className="text-[20px] leading-[100%] font-bold text-[#032746] mb-3">Password Policy</h3>
                ...
                {/* 2FA */}
                <section className="border-t pt-6 px-8">
                    <h3 className="text-[20px] leading-[100%] font-bold text-[#032746] mb-9">Two Factor Authentication (2FA)</h3>

                    <div className="flex items-center justify-between mb-10">
                        <p className="text-[16px] leading-[100%] font-normal text-[#032746]">Enable 2FA (Email / Authenticator App)</p>
                        <button
                    ...
                    <div className="flex items-center justify-between">
                        <p className="text-[16px] leading-[100%] font-normal text-[#032746]">View or reset trusted devices</p>
                ...
                <section className="border-t pt-6 px-8">
                    <h3 className="text-[20px] leading-[100%] font-bold text-[#032746] mb-[30px]">Sensitive Operations Confirmation</h3>
                    <div className="flex items-center justify-between">
                    ...
                    <div className="text-[14px] leading-[400%] text-[#6B7280]">
                ...
                <section className="border-t pt-6 px-8">
                    <div className="flex items-center justify-between mb-[30px]">
                        <h3 className="text-[20px] leading-[100%] font-bold text-[#032746] ">Login History</h3>
