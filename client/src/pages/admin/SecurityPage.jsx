        ...
        <div className="max-w-[1200px] mx-auto py-10 px-6">
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-xl pt-8 pb-10 space-y-10">
                ...
                <section className="border-t pt-6 px-8">
                    <h3 className="text-[20px] leading-[100%] font-bold text-oxford-blue mb-3">{t('admin.security.sections.passwordPolicy.title')}</h3>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-[10px] text-[16px] font-normal leading-[100%] text-blue-dark">
                        <label className="flex items-center gap-2"><input type="checkbox" /> {t('admin.security.sections.passwordPolicy.minimum8Chars')}</label>
                        <label className="flex items-center gap-2"><input type="checkbox" /> {t('admin.security.sections.passwordPolicy.atLeast1Uppercase')}</label>
                        <label className="flex items-center gap-2"><input type="checkbox" /> {t('admin.security.sections.passwordPolicy.atLeast1Lowercase')}</label>
                        <label className="flex items-center gap-2"><input type="checkbox" /> {t('admin.security.sections.passwordPolicy.atLeast1Number')}</label>
                        <label className="flex items-center gap-2"><input type="checkbox" /> {t('admin.security.sections.passwordPolicy.atLeast1SpecialChar')}</label>
                    </div>

                    <div className="flex items-center justify-between mt-[65px] text-[14px] leading-[100%] text-blue-dark">
                        <span>{t('admin.security.sections.passwordPolicy.forcePasswordChange')}</span>
                        <button
                ...
                {/* 2FA */}
                <section className="border-t pt-6 px-8">
                    <h3 className="text-[20px] leading-[100%] font-bold text-oxford-blue mb-9">{t('admin.security.sections.twoFactorAuth.title')}</h3>

                    <div className="flex items-center justify-between mb-10">
                        <p className="text-[16px] leading-[100%] font-normal text-oxford-blue">{t('admin.security.sections.twoFactorAuth.enable2FA')}</p>
                        <button
                    ...
                    <div className="flex items-center justify-between">
                        <p className="text-[16px] leading-[100%] font-normal text-oxford-blue">{t('admin.security.sections.twoFactorAuth.viewOrResetDevices')}</p>
                        <button className="text-[14px] leading-[100%] font-normal text-[#ED4122] bg-[#FDF0D5] px-[10px] py-[5px] rounded-md">{t('admin.security.sections.twoFactorAuth.manage')}</button>
                    </div>
                ...
                <section className="border-t pt-6 px-8">
                    <h3 className="text-[20px] leading-[100%] font-bold text-oxford-blue mb-[30px]">{t('admin.security.sections.sensitiveOperations.title')}</h3>
                    <div className="flex items-center justify-between">
                    ...
                    <div className="text-[14px] leading-[400%] text-dark-gray">
                        <span>{t('admin.security.sections.sensitiveOperations.preventionNote')}</span>
                    </div>
                </section>
                ...
                <section className="border-t pt-6 px-8">
                    <div className="flex items-center justify-between mb-[30px]">
                        <h3 className="text-[20px] leading-[100%] font-bold text-oxford-blue ">{t('admin.security.sections.loginHistory.title')}</h3>
                    ...
                    <div className="flex gap-4 mb-4">
                        <input placeholder={t('admin.security.sections.loginHistory.filterByUser')} className="border border-[#E5E7EB] px-3 py-2 rounded-md text-[14px] w-[344px] h-[50px]" />
                        <input placeholder={t('admin.security.sections.loginHistory.datePlaceholder')} className="border border-[#E5E7EB] px-3 py-2 rounded-md text-[14px] w-[202px]" />
                    </div>
                    <LoginHistoryTable
                        items={loginData}
