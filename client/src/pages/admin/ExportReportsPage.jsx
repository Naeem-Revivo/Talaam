              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-10">
                <div className="relative w-full">
                  <input
                    ...
                    className="w-full h-[50px] sm:h-[60px] rounded-[12px] border border-[rgba(3,39,70,0.2)] bg-white px-4 font-roboto text-[14px] sm:text-[16px] font-normal leading-[20px] text-oxford-blue outline-none cursor-pointer hover:border-[#03274666] transition shadow-input"
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-[50px] sm:h-[60px] rounded-[12px] border border-[rgba(3,39,70,0.2)] bg-white px-4 font-roboto text-[14px] sm:text-[16px] font-normal leading-[20px] text-oxford-blue outline-none hover:border-[#03274666] transition shadow-input"
                  />
                </div>
              </>
            )}
