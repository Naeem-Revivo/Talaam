...
const ProcessorProfile = () => {
  ...
  const languageOptions = [
    {
      value: "English (US)",
      label: t("processor.profile.languageOptions.english") || "English (US)",
    },
    {
      value: "Arabic",
      label: t("processor.profile.languageOptions.arabic") || "Arabic",
    },
  ];
      ...
      <div className="mx-auto flex max-w-[1200px] flex-col gap-10">
        ...
        <div className="bg-white rounded-[12px] shadow-[0px_2px_25px_0px_#0000001A]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pt-[50px] pb-[35px] px-[65px]">
            ...
            >
              <PrimaryButton
                text={isSavingProfile ? t("common.updating") || "Updating..." : t("processor.profile.saveChanges")}
        ...
        <div className="bg-white rounded-[12px] shadow-[0px_2px_25px_0px_#0000001A]">
          ...
          <div className="grid grid-cols-1 gap-6 pt-[50px] pb-[35px] px-[65px]">
            ...
            <div className={`flex ${isRTL ? "justify-start" : "justify-end"}`}>
              <PrimaryButton
                text={isSendingCode ? t("common.sending") || "Sending..." : t("processor.profile.sendCode")}
                className="py-[10px] px-7 text-nowrap"
            ...
            >
              <PrimaryButton
                text={isUpdatingPassword ? t("common.updating") || "Updating..." : t("processor.profile.updatePassword")}
                className="py-[10px] px-7 text-nowrap"
        ...
        <div className="bg-white rounded-[12px] shadow-[0px_2px_25px_0px_#0000001A]">
          ...
          <div className="space-y-8 pt-[50px] pb-[35px] px-[65px]">
            ...
            >
              <PrimaryButton
                text={isSavingSettings ? t("common.saving") || "Saving..." : t("processor.profile.saveSettings")}
                className="py-[10px] px-7 text-nowrap"
