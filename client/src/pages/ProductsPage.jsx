...
const ProductsPage = () => {
  ...
  return (
    <div className="bg-light-gradient">
      <PageHeroSection
        titleParts={[
          { text: t('products.hero.title1'), colorClass: 'text-oxford-blue', useDiv: true },
          { text: t('products.hero.title2'), colorClass: 'text-oxford-blue', useDiv: true },
          { text: t('products.hero.titleHighlight'), colorClass: 'text-cinnebar-red', useDiv: true }
        ]}
        subtitle={t('products.hero.subtitle')}
        imageSrc={logoimg}
        imageAlt="Products"
        buttons={[
          { text: t('products.hero.getStarted'), variant: 'primary' },
          { 
            text: exploreLabel === 'products.hero.exploreQbank' ? 'EXPLORE QBANK' : exploreLabel, 
            variant: 'secondary',
            icon: buttonvedio
          }
        ]}
