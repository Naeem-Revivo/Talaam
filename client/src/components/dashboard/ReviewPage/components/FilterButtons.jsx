    ...
    <div className="flex gap-2 py-[6px] px-2  bg-white border border-[#E5E7EB] shadow-md shadow-[#0000001A] rounded-[14px]">
      {options.map((option) => (
        <button
          ...
          className={`px-[30px] py-[10px] rounded-[10px] text-[14px] transition-colors font-roboto leading-[21px] tracking-[0%] text-center ${
            activeFilter === option.value
              ? 'bg-gradient-to-b from-[#032746] to-[#173B50] text-white font-medium'
