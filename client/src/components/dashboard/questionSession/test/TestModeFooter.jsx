...
const TestModeFooter = ({
  ...
  onNavigate,
  onExit,
  onPause, // preserved for compatibility
  isPauseDisabled = false, // preserved for compatibility
}) => {
  const { t } = useLanguage();
  void onPause;
  void isPauseDisabled;

  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#D4D4D4] px-4 md:px-[89px] py-3 md:py-5 z-30 shadow-footer">
