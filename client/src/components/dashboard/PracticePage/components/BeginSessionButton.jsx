...
const BeginSessionButton = ({ 
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`font-archivo font-bold text-[20px] leading-[28px] tracking-[0%] text-center rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 w-full h-[50px] md:h-[60px] ${
