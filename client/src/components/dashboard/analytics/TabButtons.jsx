    ...
    <div className={`inline-flex gap-2 w-full rounded-[14px] bg-[#F3F4F6]  mb-4 md:mb-6 ${className}`}>
      {tabs.map((tab, index) => (
        <button
          ...
          className={`w-full h-[45px] pt-3 pr-[66px] pb-3 pl-[66px] rounded-[14px] text-[14px] font-medium font-archivo leading-[21px] tracking-[0%] transition-colors whitespace-nowrap ${
            activeTab === tab.value
