...
const ProcessorSidebar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    {
      path: "/processor",
      labelKey: "processor.sidebar.dashboard",
      icon: DashboardIcon,
    },
    {
      path: "/processor/question-bank",
  ...
  return (
    ...
    >
      <div className="mb-6 p-4 pt-4 border-b border-white/10 text-white flex flex-col items-start">
        <img src={logodash} alt="Talaam Processor" className="" />
      </div>
