...
const TimingMattersSection = () => {
  ...
  return (
    <section className="bg-white w-full mobile:py-10 tablet:py-10 tablet:pb-12 h-auto tablet:h-[790px] lg:h-[590px] overflow-hidden md:overflow-visible">
        ...
        <div className={`flex flex-col tablet:flex-col laptop:flex-row md:items-center lg:items-center lg:justify-between px-4 md:px-8 lg:px-12`}>
          ...
          <div className="flex flex-col gap-3 order-2 md:order-1 tablet:pr-12 laptop:pr-0">
            <h2 className="font-archivo font-bold text-[32px] md:text-[48px] leading-[48px] tracking-[0] text-text-dark">{t('howItWorks.timingMatters.title')}</h2>
            ...
            <div className="space-y-3 md:space-y-4">
              {/* <p className="font-roboto font-normal text-[14px] md:text-[18px] leading-[22px] tracking-[0] text-text-gray">
                {t('howItWorks.timingMatters.description1')}
              </p> */}
              <p className="font-roboto font-normal text-[14px] md:text-[18px] leading-[22px] tracking-[0] text-text-gray md:w-[536px]">
            ...
            <div className="flex flex-col tablet:flex-row gap-4 mt-3 font-roboto">
              {/* Legend Items */}
              <div className={`flex flex-col gap-6 text-oxford-blue items-start ${language === 'ar' ? 'flex-row-reverse' : ''}`}>
                <div className={`flex items-center ${language === 'ar' ? 'flex-row-reverse gap-2' : 'space-x-2'}`}>
                  <span className="w-[24px] h-[4px] bg-orange-gradient "></span>
                ...
                <div className={`flex items-center justify-normal ${language === 'ar' ? 'flex-row-reverse gap-2' : 'space-x-2'}`}>
                  <span className="w-[24px] h-[4px] bg-blue-gradient "></span>
