      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center gap-8 md:gap-12">
          <div className="text-center px-5">
            <h2 className="font-archivo font-bold text-[36px] md:text-[50px] text-oxford-blue leading-[100%] tracking-[0] mb-5 w-[352px] md:w-auto">Want to Go Deeper?</h2>
            <p className="font-roboto tablet:px-10 laptop:px-0 font-normal max-w-full md:max-w-[738px] text-[15px] md:text-[20px] leading-[25px] tracking-[0] text-center text-oxford-blue">
              We're making a short video on how learning works, and the science behind the principles we use.
            </p>
          </div>
