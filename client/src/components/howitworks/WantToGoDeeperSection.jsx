      ...
      <div className="max-w-[1400px] mx-auto w-full px-4 md:px-8 lg:px-12">
        <div className="flex flex-col items-center justify-center gap-8 md:gap-12">
          <div className="text-center px-5">
            <h2 className="font-archivo font-bold text-[36px] md:text-[50px] text-oxford-blue leading-[100%] tracking-[0] mb-5 w-full md:w-auto">{t('howItWorks.wantToGoDeeper.title')}</h2>
