      ...
      <div className="max-w-[1400px] mx-auto w-full px-4 md:px-8 lg:px-12">
        <div className="flex flex-col items-center justify-center gap-8 md:gap-16 ">
          <div className="text-center px-5">
            <h2 className="font-archivo font-bold text-[17px] md:text-[40px] leading-[100%] tracking-[0] text-oxford-blue mb-5 w-full md:w-auto">{t('howItWorks.questionBank.title')}</h2>
            <p className="font-roboto font-normal mobile:px-1 text-[14px] md:text-[20px] leading-[100%] tracking-[0] text-oxford-blue">{t('howItWorks.questionBank.subtitle')}</p>
          </div>
          
          <div className="flex flex-col  laptop:flex-row  w-full md:w-auto md:pl-10 laptop:pl-0">
            {/* Left column */}
            <div className="space-y-6 pr-0 md:pr-[40px] w-full">
          ...
          <div className="w-full md:max-w-[942px] h-[125px] md:h-[126px] tablet:px-10 laptop:px-0">
