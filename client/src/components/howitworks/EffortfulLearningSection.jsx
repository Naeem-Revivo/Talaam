      ...
      <div className="max-w-[1400px] mx-auto w-full px-4 md:px-8 lg:px-12">
        <div className="flex flex-col items-center justify-center gap-8 md:gap-12">
          <div className="text-center px-5">
            <h2 className="font-archivo font-bold text-[30px] md:text-[40px] leading-[100%] tracking-[0] text-oxford-blue mb-4 w-full md:w-auto text-center">
              ...
              >
                <div className="w-full p-4 md:p-6 flex items-center gap-2 md:gap-5 rounded-lg">
                  ...
                  <div className="flex flex-col gap-1 md:gap-5 flex-1">
                    ...
                    <p className="font-roboto font-normal text-[14px] md:text-[16px] leading-[24px] tracking-[0] text-oxford-blue">
