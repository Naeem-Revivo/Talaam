...
const ExplainerSidebar = ({ isOpen, onClose }) => {
  ...
  const isActive = (path) => {
    if (path === "/explainer") {
      return location.pathname === "/explainer";
    }
    return (
...
export default ExplainerSidebar;