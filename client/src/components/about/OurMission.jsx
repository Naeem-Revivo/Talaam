      ...
      <div className="max-w-7xl mx-auto pt-5 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center gap-4 md:gap-6 lg:gap-8">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            At Taalam, we're on a mission to change how students learn—by turning learning into a skill rooted in science. In a  world where adaptability is everything, we help students master how to learn faster, better, and with purpose.
            </p>
          </div>
        </div>
      </div>
