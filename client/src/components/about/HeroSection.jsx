...
const HeroSection = () => {
  return (
    <div className="max-w-full font-archivo bg-soft-orange-fade">
      <div className="max-w-full flex flex-col md:flex-col lg:flex-row pt-8 pb-4 px-4 md:py-12 md:px-8 lg:px-[90px] lg:justify-around lg:min-h-[603px]">
        {/* Text content */}
        <div className="w-full md:w-full lg:w-[656px] flex flex-col gap-0  lg:gap-3 pt-0 md:pt-0 lg:pt-28 items-start md:items-center lg:items-start text-left md:text-center lg:text-left order-1 md:order-1 lg:order-1">
          <h1 className="leading-tight font-archivo mb-2 md:mb-2 lg:mb-2 flex items-start gap-2 md:flex md:items-center md:gap-2 lg:block text-oxford-blue">
            <span className="font-bold text-[32px] leading-[40px] md:text-[48px] md:leading-[56px] lg:text-[60px] lg:leading-[80px] tracking-[0] inline-block">About</span>
            <span className="font-bold text-orange-dark text-[32px] laptop:pl-5 leading-[40px] md:text-[48px] md:leading-[56px] lg:text-[60px] lg:leading-[80px] tracking-[0] inline-block"> Us</span>
          </h1>
          ...
          <p className="font-roboto text-oxford-blue w-full md:w-[600px] lg:w-[567px] font-normal text-[14px] leading-[22px] md:text-[16px] md:leading-[25.6px] lg:text-[16px] lg:leading-[25.6px] tracking-[0] mt-2 md:mt-2 lg:mt-0 text-left md:text-center lg:text-left">
            Learn about our curriculum and the people behind Taalam.
          </p>
