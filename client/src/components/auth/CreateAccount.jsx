      ...
      <div className="bg-white rounded-lg border border-[#03274633] shadow-lg p-4 lg:p-8 w-full lg:h-[1038px] lg:w-[505px] flex flex-col">
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className="px-4 py-3 border border-[#03274633] rounded-lg outline-none w-full lg:w-[423px] h-[59px] shadow-input"
          />
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="relative">
            <input
              ...
              className="px-4 py-3 border border-[#03274633] rounded-lg outline-none pr-12 w-full lg:w-[423px] h-[59px] shadow-input"
            />
            <button
              type="button"
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="flex items-center">
            ...
            <span className="font-roboto font-normal text-[12px] leading-none tracking-normal text-gray-700">
        ...
        <div className="flex px-4 lg:px-9 justify-center items-center">
          ...
          <span className="px-4 text-sm text-gray-500">{t('createAccount.orContinueWith')}</span>
          <div className="flex-1 border-t border-gray-300"></div>
        </div>
        ...
        <div className="flex flex-col gap-4 ">
          ...
          <button className="flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors w-full lg:w-[423px] h-[57px]">
            ...
            <span className="font-roboto font-medium text-base leading-none tracking-normal text-gray-900">{t('createAccount.continueWithGoogle')}</span>
          </button>

          {/* LinkedIn Button */}
          <button className="flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors w-full lg:w-[423px] h-[57px]">
            <img src={linkedin} alt="LinkedIn" className="" />
            <span className="font-roboto font-medium text-base leading-none tracking-normal text-gray-900">{t('createAccount.continueWithLinkedIn')}</span>
          </button>
        </div>
        </div>
        {/* Terms & Privacy */}
        <p className="font-roboto font-normal mb-5 text-sm lg:text-base leading-none tracking-normal text-center text-gray-500 pt-8 lg:pt-20">
          {t('createAccount.terms.text')}{' '}
          <a href="#" className="font-roboto font-bold text-sm lg:text-base leading-none tracking-normal text-center underline text-cinnebar-red">
