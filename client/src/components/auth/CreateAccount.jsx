          ...
          <div className="flex flex-col gap-6 lg:gap-8">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="px-4 py-3 border border-[#03274633] rounded-lg outline-none w-full lg:w-[423px] h-[59px] shadow-input font-roboto text-[16px] leading-[100%] tracking-[0] text-oxford-blue placeholder:text-[14px] placeholder:leading-[100%] placeholder:tracking-[0] placeholder:text-[#6B7280]"
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="px-4 py-3 border border-[#03274633] rounded-lg outline-none pr-12 w-full lg:w-[423px] h-[59px] shadow-input font-roboto text-[16px] leading-[100%] tracking-[0] text-oxford-blue placeholder:text-[14px] placeholder:leading-[100%] placeholder:tracking-[0] placeholder:text-[#6B7280]"
                />
                <button
                  type="button"
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="flex items-center">
                ...
                <span className="font-roboto font-normal text-[14px] leading-[100%] tracking-[0] text-gray-700">
