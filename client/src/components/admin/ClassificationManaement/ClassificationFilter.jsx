        ...
        <section className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between lg:gap-6">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-5 w-full">
                ...
                <div className="w-full lg:w-[580px]">
                    ...
                    <div
                        className="relative flex items-center h-[48px] rounded-lg bg-white shadow-[0_8px_20px_rgba(3,39,70,0.05)]
    focus-within:border-[#032746] focus-within:ring-2 focus-within:ring-[#D6E3F0] border border-transparent transition-all duration-150"
                    >
