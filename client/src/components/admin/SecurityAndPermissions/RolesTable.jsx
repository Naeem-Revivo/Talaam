                ...
                if (fieldKey === 'status') {
                    ...
                    return (
                        <td key={column} className="px-6 py-4 text-center">
                            <span className={`inline-block px-[12px] py-[5px] rounded-md text-[14px] leading-[100%] font-normal ${isActive ? 'bg-[#FDF0D5] text-[#ED4122]' : 'bg-[#C6D8D3] text-[#032746]'
                                }`}>
                                {value}
                            </span>
                        </td>
        ...
        <article className="flex flex-col rounded-[8px] border border-[#E5E7EB] bg-white shadow-sm md:hidden overflow-hidden">
                ...
                {displayColumns.map((column) => {
                    ...
                    return (
                        <div key={column} className="flex items-center gap-2">
                            <span className="text-[14px] font-normal text-[#032746]">{column}:</span>
                            <span className="text-[14px] font-normal text-[#6B7280]">{value}</span>
                        </div>
                    );
                })}
            </div>
            ...
            <div className="flex items-center justify-between border-t border-[#E5E7EB] bg-[#F9FAFB] px-4 py-2.5">
                ...
                {(() => {
                    ...
                    return (
                        <span className={`inline-flex items-center px-[12px] py-[5px] rounded-md text-[14px] font-normal ${isActive ? 'bg-[#FDF0D5] text-[#ED4122]' : 'bg-[#C6D8D3] text-[#032746]'
                            }`}>
                            {statusValue}
                        </span>
                    );
