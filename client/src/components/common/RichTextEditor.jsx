  ...
  return (
    <div className="rounded-[8px] w-full h-auto lg:h-[208px] min-h-[150px] border border-[#CDD4DA] bg-white overflow-hidden">
      ...
      <div className="flex items-center flex-wrap gap-2 border-b border-[#CDD4DA] bg-[#F6F7F8] py-3 px-2 rounded-t-[8px]">
        ...
        <button
          type="button"
          onClick={handleToolbarClick(() => handleCommand("formatBlock", "<code>"))}
          className="p-0 hover:opacity-80 transition"
          title="Code"
        >
          <svg
        ...
        <button
          type="button"
          onClick={handleToolbarClick(() => handleCommand("formatBlock", "<h1>"))}
          className="p-0 hover:opacity-80 transition"
          title="Heading"
        >
          <svg
        ...
        <button
          type="button"
          onClick={handleToolbarClick(() => handleCommand("insertUnorderedList"))}
          className="p-0 hover:opacity-80 transition"
          title="Bullet List"
        >
          <svg
        ...
        <button
          type="button"
          onClick={handleToolbarClick(() => handleCommand("insertOrderedList"))}
          className="p-0 hover:opacity-80 transition"
          title="Numbered List"
        >
          <svg
        ...
        <button
          type="button"
          onClick={handleToolbarClick(handleLink)}
          className="p-0 hover:opacity-80 transition"
          title="Link"
        >
          <svg
        ...
        <button
          type="button"
          onClick={handleToolbarClick(handleImage)}
          className="p-0 hover:opacity-80 transition"
          title="Image"
        >
          <svg
        ...
        <button
          type="button"
          onClick={handleToolbarClick(() => handleCommand("formatBlock", "<pre>"))}
          className="p-0 hover:opacity-80 transition"
          title="Code"
        >
          <svg
        ...
        <button
          type="button"
          onClick={handleToolbarClick(() => handleCommand("undo"))}
          className="p-0 hover:opacity-80 transition"
          title="Undo"
        >
          <svg
        ...
        <button
          type="button"
          onClick={handleToolbarClick(() => handleCommand("redo"))}
          className="p-0 hover:opacity-80 transition"
          title="Redo"
        >
          <svg
