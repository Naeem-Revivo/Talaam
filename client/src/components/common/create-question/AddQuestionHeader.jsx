...
const AddQuestionHeader = ({ t, onCancel, onSubmit, submitting, titleKey, cancelKey, submitKey }) => {
  ...
  const defaultSubmitKey = submitKey || "admin.addNewQuestion.buttons.submit";
  ...
  return (
    <header className="flex flex-col md:flex-row justify-between gap-4 items-start md:items-center mb-10">
      ...
      <div className="flex flex-wrap gap-2 md:gap-4 w-full md:w-auto">
        ...
        >
          {submitting ? "Submitting..." : t(defaultSubmitKey)}
        </button>
      </div>
    </header>
  );
