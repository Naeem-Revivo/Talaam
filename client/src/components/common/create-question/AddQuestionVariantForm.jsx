...
const AddQuestionVariantForm = ({
  ...
  return (
    <div className="bg-white rounded-[14px] border border-[#03274633] px-[30px] pt-[50px] pb-10 mb-6">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <RichTextEditor
            ...
            onChange={(value) => onExplanationChange(variant.id, value)}
...
export default AddQuestionVariantForm;
