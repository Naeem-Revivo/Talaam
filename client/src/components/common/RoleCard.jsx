export const RoleCard = ({ role, tasks, pendingCount, roleLabel, pendingTasksLabel }) => {
  return (
    <div className="rounded-[14px] shadow-[0px_4px_50px_0px_#0327461F] border border-[#03274633] overflow-hidden w-full">
      <div className="border-b border-[#CDD4DA] pt-12 pb-6 py-4 text-center">
        <h2 className="text-[24px] leading-[100%] font-bold text-blue-dark text-archivo">{roleLabel}: {role}</h2>
      </div>
